...
pytestmark = pytest.mark.skipif(
    CliRunner is None, reason="requires typer.testing.CliRunner"
)
...
class TestCli:
    ...
    def test_cli_plugins_list(
        self, cli_runner: CliRunner, kitty_cli: object
    ) -> None:
    ...
    def test_cli_eval_invalid_config(
        self, cli_runner: CliRunner, kitty_cli: object
    ) -> None:
